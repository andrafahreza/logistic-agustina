...
@section('contents')
    <div class="pagetitle">
        <h1>Kepala Perusahaan</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item">Master Data</li>
                <li class="breadcrumb-item">Pengguna</li>
                <li class="breadcrumb-item active">Kepala Perusahaan</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <div class="modal fade" id="tambah" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('simpan-kepala') }}" method="POST" id="formTambah">
                    @csrf
    ...
    <div class="modal fade" id="hapus" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('hapus-kepala') }}" method="POST" id="formTHapus">
                    @csrf
...
@push("scripts")
    ...
    <script>
        $('#btnTambah').click(function() {
            ...
            $('#formTambah')[0].reset();
            $('#formTambah').attr("action", "{{ route('simpan-kepala') }}")
        });
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.alert == '1') {
                        ...
                        $('#formTambah')[0].reset();
                        $('#formTambah').attr("action", "{{ route('simpan-kepala') }}" + "/" + data.id);
