...
@section('contents')
    ...
    <div class="modal fade" id="tambah" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('simpan-operator') }}" method="POST" id="formTambah">
                    @csrf
    ...
    <div class="modal fade" id="hapus" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('hapus-operator') }}" method="POST" id="formTHapus">
                    @csrf
    ...
    <div class="modal fade" id="nonActive" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('nonactive-operator') }}" method="POST" id="formTnonactive">
                    @csrf
                    <input type="hidden" name="id" id="idNonActive">
                    <div class="modal-header">
                        <h5 class="modal-title">Nonaktifkan operator</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>Yakin ingin menonaktifkan operator ini?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
    ...
    <div class="modal fade" id="active" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('active-operator') }}" method="POST" id="formActive">
                    @csrf
                    <input type="hidden" name="id" id="idActive">
                    <div class="modal-header">
                        <h5 class="modal-title">Aktifkan operator</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>Yakin ingin mengaktifkan operator ini?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
...
@push("scripts")
    ...
    <script>
        $('#btnTambah').click(function() {
            ...
            $('#formTambah')[0].reset();
            $('#formTambah').attr("action", "{{ route('simpan-operator') }}")
        });
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.alert == '1') {
                        ...
                        $('#formTambah')[0].reset();
                        $('#formTambah').attr("action", "{{ route('simpan-operator') }}" + "/" + data.id);
